        ...
        if (tag.hasUUID(TAG_COUPLED_UUID_1) && tag.hasUUID(TAG_COUPLED_UUID_2)){
            ...
            if (ent1 != null && ent2 != null && ent1 != ent2) {
                ...
                if (distance < 3) {
                    ...
                    List<CouplerEntity> list = worldIn.getEntities(MMEntities.COUPLER_ENTITY,
                    ...
                    if (!is_duplicate) {
                        CouplerEntity coupler_ent = new CouplerEntity(MMEntities.COUPLER_ENTITY, worldIn, ent1, ent2);
